  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
        ...
        <button className="p-6 bg-red-600 text-white rounded-xl hover:bg-red-700 transition-colors">
          <h3 className="text-xl font-bold mb-2">Komorbiditet</h3>
          <p className="text-sm opacity-90">Sammenhænge mellem diagnoser</p>
        </button>
        
        <button className="p-6 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-colors">
